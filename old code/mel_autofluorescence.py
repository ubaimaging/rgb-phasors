...
part2 = True  # part2 is for the comparison with the HSI data
if part2:
    imm = plt.imread("/Users/schutyb/Documents/Projects/rgb-phasors/data/autofluorescencia/hsi-nev-mel/sp_16556_r1.lsm")
    imn = plt.imread("/Users/schutyb/Documents/Projects/rgb-phasors/data/autofluorescencia/nev-mel/16252_10x_r1.tif")
